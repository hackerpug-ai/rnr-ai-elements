...
| `pnpm exec tsc --noEmit -p apps/example` | 0 errors, which is what proves the fixture's shape satisfies the real `ai@7.0.89` UIMessage type rather than merely being valid JSON |
