...
end_state:
  must_observe: ["Developer can browse a file tree of the agent workspace and expand and collapse directories on a phone-width screen."]
...
---
# Repository and environment context on a phone screen — core flow

File tree, commits, package info, and environment variables rendered for narrow screens with copy and reveal affordances.

Verify on an iOS simulator AND an Android emulator: Developer can browse a file tree of the agent workspace and expand and collapse directories on a phone-width screen.
